...
PROBLEM_FILE = accretion_SingleNR_FixedKappa_2D.cpp
...
CXX := mpicxx
CPPFLAGS :=  -I/apps/hdf5/intel/18.0/mvapich2/2.3/1.10.2/include
CXXFLAGS := -O3 -std=c++11
LDFLAGS :=  -L/apps/hdf5/intel/18.0/mvapich2/2.3/1.10.2/lib
LDLIBS :=  -lhdf5
GCOV_CMD := gcov
